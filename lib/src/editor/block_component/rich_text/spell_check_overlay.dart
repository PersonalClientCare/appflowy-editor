...
class _SpellCheckOverlayState extends State<SpellCheckOverlay> {
  ...
  Future<void> _showSuggestionsPopup(
    ...
    final suggestions = SpellChecker.instance.suggest(word, maxSuggestions: 5);
              ...
              child: Column(
                ...
                children: suggestions.map((suggestion) {
                  return InkWell(
                    ...
                    hoverColor: widget.highlightColor ??
  ...
  Future<void> _replaceMisspelledWord(
    ...
    final correctedAttributes = widget.node.attributes;
    AppFlowyEditorLog.editor.error(
      "Words current attributes: $correctedAttributes",
    );
